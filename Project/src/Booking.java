...
class Movie1 {
    ...
    public Movie1(String title, String day, String time, String location, int availableSeats, double pricePerTicket) {
        this.title = title;
        this.day = day;
        this.time = time;
    ...
    public class Booking {
        public static void main(String[] args) {
            ...
            // Now you have objects representing each movie, you can use them as needed.
            // For example, you can display their details or store them in a list for further processing.
            ...
            System.out.println("3. " + movie3.getTitle() + " - " + movie3.getDay() + " " + movie3.getTime() + " at " + movie3.getLocation() + "(" + movie3.getAvailableSeats() +" "+"seats available)");
            System.out.println("4. " + movie4.getTitle() + " - " + movie4.getDay() + " " + movie4.getTime() + " at " + movie4.getLocation() + "(" + movie4.getAvailableSeats() +" "+"seats available)");
            System.out.println("5. " + movie5.getTitle() + " - " + movie5.getDay() + " " + movie5.getTime() + " at " + movie5.getLocation() + "(" + movie5.getAvailableSeats() +" "+"seats available)");
            System.out.println("6. " + movie6.getTitle() + " - " + movie6.getDay() + " " + movie6.getTime() + " at " + movie6.getLocation() + "(" + movie6.getAvailableSeats() +" "+"seats available)");
            System.out.println("7. " + movie7.getTitle() + " - " + movie7.getDay() + " " + movie7.getTime() + " at " + movie7.getLocation() + "(" + movie7.getAvailableSeats() +" "+"seats available)");
            System.out.println("8. " + movie8.getTitle() + " - " + movie8.getDay() + " " + movie8.getTime() + " at " + movie8.getLocation() + "(" + movie8.getAvailableSeats() +" "+"seats available)");
            System.out.println("9. " + movie9.getTitle() + " - " + movie9.getDay() + " " + movie9.getTime() + " at " + movie9.getLocation() + "(" + movie9.getAvailableSeats() +" "+"seats available)");
